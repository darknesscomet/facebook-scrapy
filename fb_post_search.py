...
def parse_html(html_source, keyword):
    ...
    for link in soup.find_all('a'):
        if link.get("href") and "post" in link.get("href").lower() and link.get("href") != "#" and "?" not in link.get("href") and "http" in link.get("href"):
            result.append({"keyword": keyword, "url": link.get("href")})
